...
<div class="w-full sm:w-1/3 pt-1">
  <div class="p-2 flex flex-col sm:flex-row justify-between items-start sm:items-center">
    <div class="flex">
    ...
    <p class="text-sm sm:text-base md:text-lg text-gray-500">
      Fuente de información: <a class="font-semibold hover:text-white" href="https://covid19api.com/" target="_blank">COVID19API</a>
    </p>
  </div>
  <div class="flex flex-col md:flex-row">
    <div class="flex-grow text-left px-4 py-2 text-center sm:border-r border-gray-700">
      <p class="text-sm font-bold text-yellow-400">
        Confirmados
      </p>
      <p class="text-2xl font-bold tracking-wide text-yellow-400">
        {totalConfirmed}
      </p>
    </div>
    ...
    <div class="flex-grow text-left px-4 py-2 text-center">
